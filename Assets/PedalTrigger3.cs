...
public class PedalTrigger3 : MonoBehaviour
{
    ...
    public float moveDistance = 15f;  // Distance the path will move upward
    ...
    private IEnumerator MovePathUpward()
    {
        ...
        while (Vector3.Distance(pathToActivate.transform.position, targetPosition) > 0.05f)
        {
